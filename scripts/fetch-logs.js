...
function getGitHubToken() {
  try {
    ...
    console.error('No GitHub token found. Run: git config --global github.token YOUR_TOKEN');
    process.exit(1);
  }
}
...
async function fetchLogs() {
  ...
  try {
    ...
    if (error.message.includes('401')) {
      ...
      console.log('Please create a new token at: https://github.com/settings/tokens');
    }
  }
}
