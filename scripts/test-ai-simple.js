...
async function testAI() {
  ...
  try {
    ...
    console.log(
      "✅ AI says it has access to 294 businesses across 10 industries!\n",
    );

    // Click a suggested question
    console.log(
      '🤖 Clicking suggested question: "What are the top performing industries in Charlotte?"',
    );
    await page.click(
      "text=What are the top performing industries in Charlotte?",
    );
  ...
  console.log(
    "   The browser window will stay open for 10 seconds so you can explore...",
  );
