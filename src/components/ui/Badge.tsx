  ...
  'inline-flex items-center rounded-lg border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success: 'border-transparent bg-success text-success-foreground shadow-sleek',
        warning: 'border-transparent bg-warning text-warning-foreground shadow-sleek',
...
export function CountBadge({ 
  ...
  return (
    <Badge 
      variant='destructive' 
      size='sm'
      className={cn('rounded-full px-1.5 min-w-[1.25rem] justify-center', className)}
    >
      {displayCount}
    </Badge>
  )
