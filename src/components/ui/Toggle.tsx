...
const toggleVariants = cva(
  'relative inline-flex shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-all duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
        sm: 'h-5 w-9',
      ...
      variant: {
        ...
        glass: 'bg-glass backdrop-blur-md border-glass-border data-[checked]:bg-primary/80 shadow-glow',
        midnight: 'bg-midnight-700 data-[checked]:bg-midnight-500 shadow-midnight',
      },
    },
    defaultVariants: {
      size: 'default',
...
const Toggle = forwardRef<HTMLButtonElement, ToggleProps>(
  ({ size, variant, checked, onChange, disabled, label, description, className, 'aria-label': ariaLabel }, ref) => {
    return (
