...
export function HomePage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Real-time economic intelligence for the Greater Charlotte
            metropolitan area
          </p>
        </div>
            ...
            {recentNews.map((item) => (
              <div
                ...
                className={`flex items-start space-x-4 p-4 rounded-xl border transition-colors duration-200 hover:bg-accent cursor-pointer ${
                  isDarkMode
                    ? "border-midnight-700 hover:bg-midnight-800"
      ...
      {/* Bottom CTA Section */}
      <Card
        variant={isDarkMode ? "midnight" : "elevated"}
      ...
      >
        <CardContent className="py-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Discover insights about local businesses, track market trends, and
            stay informed about the latest developments in the Charlotte
            metropolitan area.
          </p>
