...
const AISystemCheck: React.FC = () => {
  ...
  const performHealthCheck = async () => {
    ...
    try {
      ...
      setHealthCheck({
        ...
        recommendations: [
          "Failed to connect to database. Check your Supabase configuration.",
        ],
      });
    } finally {
      setIsLoading(false);
  ...
  const runIntelligenceTests = async () => {
    ...
    const testQueries = [
      ...
      {
        query: "What are the latest business developments",
        type: "developments",
      },
      { query: "Economic indicators for Charlotte", type: "economic" },
      {
        query: "Give me a comprehensive market overview",
        type: "comprehensive",
      },
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 grid grid-cols-2 md:grid-cols-3 gap-2">
                  {Object.entries(healthCheck.tables).map(
                    ([table, available]) => (
                      <div
                        key={table}
              ...
              <div>
                ...
                <div className="mt-2 grid grid-cols-2 md:grid-cols-3 gap-2">
                  {Object.entries(healthCheck.dataCounts).map(
                    ([table, count]) => (
                      <div
                        key={table}
                  ...
                  {result.success && result.data ? (
                    <div className="text-sm text-gray-600">
                      ...
                      <div className="mb-2">
                        ...
                        {result.data.metadata?.resultCount || "N/A"} items found
                      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Overall AI system health and capabilities
          </CardDescription>
        </CardHeader>
        <CardContent>
